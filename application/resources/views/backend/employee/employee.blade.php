                ...
                <form class="" action="{{route('backend.employee.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <input class="form-control" id="name" type="text" name="name" placeholder="Employee Name">
                        </div>
                        <div class="mb-3 col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input class="form-control" id="salary" type="number" name="salary" placeholder="Salary">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-6">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input class="form-control" id="city" type="text" name="city" placeholder="City Name">
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3 col-6">
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <input class="form-control" id="vacation" type="number" name="vacation" placeholder="Vacation">
                        </div>
                        <div class="mb-3 col-6">
